...
it offers an image editor object that takes an image and shows a toolbar and calls activate/deactivate handlers for tools defined in a configuration object.
better crop handling, text annotations and arrows are on the roadmap.
